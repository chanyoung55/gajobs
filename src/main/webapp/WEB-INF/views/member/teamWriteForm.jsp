...
<body>
	<div class="container" align="center">
		<h2 class="text-primary mt-3">팀 추가</h2>
		<form action="${path }/member/teamWrite" method="post" name="frm" onsubmit="return chk();">
		...
		<table class="mt-5" style="width: 50%;">
			<tr>
				...
				<td align="center" style="padding:0; height: 40px; line-height: 40px;">
					<input class="form-control" type="text" id="t_name" name="t_name" style="display: inline-block; width: 50%; height: 40px;" onkeyup="teamChk(this)" placeholder="팀명을 입력해주세요">
				</td>
			</tr>
			<tr>
				<td>
