...
<body>
	<div class="container" align="center">
		<h2 class="text-primary mt-3">지점명 수정</h2>
		<div align="left" >
			
		</div>
		<form action="${path }/member/branchUpdate" method="post" name="frm" onsubmit="return chk();">
		<input type="hidden" value="${branch.b_seq }" name="b_seq">
		<table class="mt-5" style="width: 50%;">
			<tr>
				...
				<td align="center" style="padding:0; height: 40px; line-height: 40px;">
					<input class="form-control" type="text" id="b_name" name="b_name" style="display: inline-block; width: 50%; height: 40px;" onkeyup="branchChk(this)" placeholder="지점명을 입력해주세요" value="${branch.b_name }">
				</td>
			</tr>
			<tr>
				<td>
