...
/* drap and drop */
    ...
    function uploadFile(){
        ...
        if(frm.e_title.value=="") {
            ...
            formData.append('e_writer',frm.e_writer.value);
            ...
            $.ajax({
                url:"${path}/education/educationWrite/pageNum/${pageNum}",
                data:formData,
                type:'POST',
                ...
                success:function(data){
                        alert("글이 등록되었습니다.");
                        location.href="${path}/education/educationMain/pageNum/${pageNum}";
                }
            });
        }
       }
...
<body>
	<div class="container" align="center">
		...
		<div align="left" style="width: 100%;">
			<a class="btn btn-warning btn-lg" href="${path}/education/educationMain/pageNum/${pageNum}">뒤로</a>
		</div>
		<form name="frm" method="post" enctype="multipart/form-data" id="frm">
			<input type="hidden" name="e_writer" value="${sideNav.m_name }">
			<input type="hidden" name="m_id" value="${sideNav.m_id }">
			<table class="table table-bordered mt-1">
					<tr>
						<th style="vertical-align: middle;">제목</th>
						<td><input type="text" class="form-control" name="e_title" required="required" autofocus="autofocus"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">
							<textarea id="summernote" name="e_content" rows="10" cols="100" required="required"></textarea>
						</td>
					</tr>
					<tr>
